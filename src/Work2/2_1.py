...
def main():
    ...
    for i in range(12):
        cube_edges[i, 0] = edges[i][0]
        cube_edges[i, 1] = edges[i][1]
    ...
    while gui.running:
        ...
        # 绘制立方体12条边
        for i in range(12):
            start = screen_coords[cube_edges[i, 0]]
            end = screen_coords[cube_edges[i, 1]]
